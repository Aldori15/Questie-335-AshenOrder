...
> [!IMPORTANT]
> # Setup / Installation
> - Download [the latest release here](https://github.com/Aldori15/Questie-335-AshenOrder/releases/latest).
> - Extract both folders "Questie-335" and "Questie-AshenOrder" to the Interface > Addons folder in your client.
> - The first/initial login after installing the addons will take about a minute to compile the Questie database in-game, which is displayed in the chatbox.
