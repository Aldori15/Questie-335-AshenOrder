...
local eventsLocales = {
    ...
    ["|cFF00B0E8Scourge Invasion"] = {
        ["ptBR"] = "Invasão do Flagelo",
        ["ruRU"] = "Вторжение Плети",
        ["deDE"] = "Geißelinvasion",
        ["koKR"] = "스컬지 침공",
        ["esMX"] = "Invasión de la Plaga",
        ["enUS"] = true,
        ["frFR"] = "Invasion du Fléau",
        ["esES"] = "Invasión de la Plaga",
        ["zhTW"] = "天灾入侵",
        ["zhCN"] = "天灾入侵",
    },
    ["Exiled Enclave"] = {
        ["ptBR"] = "Enclave Exilado",
        ["ruRU"] = "Изгнанный Анклав",
        ["deDE"] = "Exil-Enklave",
        ["koKR"] = "추방된 영토",
        ["esMX"] = "Enclave exiliado",
        ["enUS"] = true,
        ["frFR"] = "Enclave exilée",
        ["esES"] = "Enclave exiliado",
        ["zhTW"] = "流放飞地",
        ["zhCN"] = "流放飞地",
    },
    ["Stormwind City"] = {
        ["ptBR"] = "Cidade de Ventobravo",
        ["ruRU"] = "Штормград",
        ["deDE"] = "Stadt Sturmwind",
        ["koKR"] = "스톰윈드 시티",
        ["esMX"] = "Ciudad de Ventormenta",
        ["enUS"] = true,
        ["frFR"] = "Ville de Hurlevent",
