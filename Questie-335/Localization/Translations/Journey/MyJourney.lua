...
local myJourneyLocales = {
    ...
    ["Daily quest limit reached"] = {
        ["enUS"] = true,
        ["deDE"] = "Tagesquestlimit erreicht",
        ["esES"] = "Límite de misiones diarias alcanzado",
        ["esMX"] = "Límite de misiones diarias alcanzado",
        ["frFR"] = "Limite de quêtes journalières atteinte",
        ["koKR"] = "일일 퀘스트 한도 도달",
        ["ptBR"] = "Limite de missões diárias atingido",
        ["ruRU"] = "Достигнут лимит ежедневных заданий",
        ["zhCN"] = "已达到日常任务上限",
        ["zhTW"] = "已達到日常任務上限",
    },
