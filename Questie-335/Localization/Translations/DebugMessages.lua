...
local debugMessagesLocales = {
    ...
    -- },
    ["The quest %s is missing from Questie's database. Please contact @Aldori on Discord or report this as a bug on the 'Questie-335-AshenOrder' GitHub repo."] = {
        ["ptBR"] = "A missão %s está faltando no banco de dados de Questie. Entre em contato com @Aldori no Discord ou relate isso como um bug no repositório GitHub 'Questie-335-AshenOrder'.",
        ["ruRU"] = "Квест %s отсутствует в базе данных Questie. Пожалуйста, свяжитесь с @Aldori в Discord или сообщите об этом как об ошибке в репозитории Questie-335-AshenOrder на GitHub.",
        ["koKR"] = "Questie의 데이터베이스에 %s 퀘스트가 없습니다. Discord에서 @Aldori에게 문의하거나 'Questie-335-AshenOrder' GitHub 저장소에 버그로 신고해 주세요.",
        ["frFR"] = "La quête %s est absente de la base de données de Questie. Veuillez contacter @Aldori sur Discord ou signaler cela comme un bug sur le dépôt GitHub « Questie-335-AshenOrder ».",
        ["zhCN"] = "Questie 的数据库中缺少任务 %s。请在 Discord 上联系 @Aldori 或将此问题报告为“Questie-335-AshenOrder”GitHub 存储库上的错误。",
        ["enUS"] = true,
        ["zhTW"] = "Questie 的数据库中缺少任务 %s。请在 Discord 上联系 @Aldori 或将此问题报告为“Questie-335-AshenOrder”GitHub 存储库上的错误。",
        ["deDE"] = "Die Quest %s fehlt in Questies Datenbank. Bitte kontaktieren Sie @Aldori auf Discord oder melden Sie dies als Fehler im GitHub-Repo „Questie-335-AshenOrder“.",
        ["esES"] = "La misión %s no está en la base de datos de Questie. Comuníquese con @Aldori en Discord o informe esto como un error en el repositorio de GitHub 'Questie-335-AshenOrder'.",
        ["esMX"] = "La misión %s no está en la base de datos de Questie. Comuníquese con @Aldori en Discord o informe esto como un error en el repositorio de GitHub 'Questie-335-AshenOrder'.",
    },
