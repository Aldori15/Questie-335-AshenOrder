...
local debugMessagesLocales = {
    ...
    -- },
    ["The quest %s is missing from Questie's database. Please contact @Aldori on Discord or report in the WoW Repacks Community Discord under the 'Questie - Missing Database Quests' thread found in the #ashen-addons channel."] = {
        ["ptBR"] = "A missão %s está faltando no banco de dados de Questie. Entre em contato com @Aldori no Discord ou relate no WoW Repacks Community Discord no tópico 'Questie - Missing Database Quests' encontrado no canal #ashen-addons.",
        ["ruRU"] = "Квест %s отсутствует в базе данных Questie. Пожалуйста, свяжитесь с @Aldori в Discord или сообщите об этом в Discord сообщества WoW Repacks в теме «Questie — Missing Database Quests» на канале #ashen-addons.",
        ["koKR"] = "Questie의 데이터베이스에 %s 퀘스트가 없습니다. Discord에서 @Aldori에게 연락하거나 WoW Repacks Community Discord의 #ashen-addons 채널에 있는 'Questie - Missing Database Quests' 스레드 아래에 신고해 주세요.",
        ["frFR"] = "La quête %s est absente de la base de données de Questie. Veuillez contacter @Aldori sur Discord ou signaler dans le Discord de la communauté WoW Repacks sous le fil de discussion « Questie - Missing Database Quests » trouvé dans le canal #ashen-addons.",
        ["zhCN"] = "Questie 的数据库中缺少任务 %s。请在 Discord 上联系 @Aldori 或在 #ashen-addons 频道中找到的“Questie - 缺少数据库任务”主题下的 WoW Repacks 社区 Discord 中进行举报。",
        ["enUS"] = true,
        ["zhTW"] = "Questie 的数据库中缺少任务 %s。请在 Discord 上联系 @Aldori 或在 #ashen-addons 频道中找到的“Questie - 缺少数据库任务”主题下的 WoW Repacks 社区 Discord 中进行举报。",
        ["deDE"] = "Die Quest %s fehlt in Questies Datenbank. Bitte kontaktieren Sie @Aldori auf Discord oder melden Sie sich im WoW Repacks Community Discord unter dem Thread „Questie – Missing Database Quests“ im Kanal #ashen-addons.",
        ["esES"] = "La misión %s no está en la base de datos de Questie. Comuníquese con @Aldori en Discord o informe en WoW Repacks Community Discord en el hilo 'Questie - Missing Database Quests' que se encuentra en el canal #ashen-addons.",
        ["esMX"] = "La misión %s no está en la base de datos de Questie. Comuníquese con @Aldori en Discord o informe en WoW Repacks Community Discord en el hilo 'Questie - Missing Database Quests' que se encuentra en el canal #ashen-addons.",
    },
