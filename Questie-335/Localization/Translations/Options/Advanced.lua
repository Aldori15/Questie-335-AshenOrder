...
local advancedOptionsLocales = {
    ...
    ["Questie-335 is under active development for World of Warcraft: Wotlk 3.3.5a, targeting AzerothCore for data accuracy. Please check GitHub for the latest changes or to report issues."] = {
        ["ptBR"] = "Questie-335 está em desenvolvimento ativo para World of Warcraft: Wotlk 3.3.5a, visando o AzerothCore para precisão dos dados. Verifique o GitHub para as últimas alterações ou para relatar problemas.",
        ["ruRU"] = "Questie-335 находится в активной разработке для World of Warcraft: Wotlk 3.3.5a и ориентирован на AzerothCore для точности данных. Пожалуйста, проверьте GitHub на предмет последних изменений или чтобы сообщить об ошибках.",
        ["deDE"] = "Questie-335 befindet sich in aktiver Entwicklung für World of Warcraft: Wotlk 3.3.5a und zielt auf AzerothCore für Datengenauigkeit ab. Bitte prüfen Sie GitHub für die neuesten Änderungen oder um Probleme zu melden.",
        ["koKR"] = "Questie-335은 World of Warcraft: Wotlk 3.3.5a 용으로 활발히 개발 중이며 데이터 정확성을 위해 AzerothCore를 목표로 합니다. 최신 변경 사항 확인이나 문제 신고는 GitHub를 확인하세요.",
        ["esMX"] = "Questie-335 está en desarrollo activo para World of Warcraft: Wotlk 3.3.5a, orientado a AzerothCore para la precisión de los datos. Por favor, consulte GitHub para los últimos cambios o para reportar problemas.",
        ["enUS"] = true,
        ["zhCN"] = "Questie-335 正在为 World of Warcraft: Wotlk 3.3.5a 积极开发，目标是通过 AzerothCore 保证数据准确性。请到 GitHub 查看最新更改或报告问题。",
        ["zhTW"] = "Questie-335 正在為 World of Warcraft: Wotlk 3.3.5a 積極開發，目標是以 AzerothCore 確保資料準確性。請到 GitHub 檢視最新變更或回報問題。",
        ["esES"] = "Questie-335 está en desarrollo activo para World of Warcraft: Wotlk 3.3.5a, orientado a AzerothCore para la precisión de los datos. Por favor, consulte GitHub para los últimos cambios o para reportar problemas.",
        ["frFR"] = "Questie-335 est en cours de développement actif pour World of Warcraft : Wotlk 3.3.5a, ciblant AzerothCore pour l'exactitude des données. Veuillez consulter GitHub pour les dernières modifications ou pour signaler des problèmes.",
    },
    ["Skip Validation"] = {
