...
local iconOptionsLocales = {
    ...
    ["When this is enabled, the locations of the Scourge Invasion quests will be shown on the map/minimap. Enable this only if your server has the Scourge Invasion worldstate event active."] = {
        ["ptBR"] = "Quando ativado, os locais das missões da Invasão do Flagelo serão mostrados no mapa/minimapa. Ative isso somente se o seu servidor tiver o evento de estado do mundo Invasão do Flagelo ativo.",
        ["ruRU"] = "Если включено, расположения заданий Нашествия Плети будут отображаться на карте/миникарте. Включайте только если на вашем сервере активно мировое событие Нашествие Плети.",
        ["deDE"] = "Wenn aktiviert, werden die Standorte der Geißel-Invasions-Quests auf der Karte/Minimap angezeigt. Aktiviere dies nur, wenn dein Server das Geißel-Invasions-Weltereignis aktiv hat.",
        ["koKR"] = "활성화하면 역병 침략 퀘스트의 위치가 지도/소형지도에 표시됩니다. 서버에 역병 침략 월드 상태 이벤트가 활성화된 경우에만 활성화하십시오.",
        ["esMX"] = "Cuando está habilitado, las ubicaciones de las misiones de la Invasión de la Plaga se mostrarán en el mapa/minimapa. Habilita esto solo si tu servidor tiene el evento de estado del mundo Invasión de la Plaga activo.",
        ["enUS"] = true,
        ["zhCN"] = "启用后，天灾入侵任务的位置将显示在地图/小地图上。仅当您的服务器拥有天灾入侵世界状态事件时才启用此功能。",
        ["zhTW"] = "啟用後，天災入侵任務的位置將顯示在地圖/小地圖上。僅當您的伺服器有天災入侵世界狀態事件時才啟用此功能。",
        ["esES"] = "Cuando está habilitado, las ubicaciones de las misiones de la Invasión de la Plaga se mostrarán en el mapa/minimapa. Habilita esto solo si tu servidor tiene el evento de estado del mundo Invasión de la Plaga activo.",
        ["frFR"] = "Lorsque cette option est activée, les emplacements des quêtes d'Invasion du Fléau seront affichés sur la carte/minimap. Activez ceci uniquement si votre serveur a l'événement d'état du monde Invasion du Fléau actif.",
    },
    ...
    ["When this is enabled, the locations of the Battle for Sun's Reach quests will be shown on the map/minimap. Enable this only if your server has the Sun's Reach worldstate event active."] = {
        ["ptBR"] = "Quando ativado, os locais das missões da Batalha pelo Alcance do Sol serão mostrados no mapa/minimapa. Ative isso somente se o seu servidor tiver o evento de estado do mundo Alcance do Sol ativo.",
        ["ruRU"] = "Если включено, расположения заданий Битвы за Достижение Солнца будут отображаться на карте/миникарте. Включайте только если на вашем сервере активно мировое событие Достижение Солнца.",
        ["deDE"] = "Wenn aktiviert, werden die Standorte der Quests der Schlacht um die Sonnenwacht auf der Karte/Minimap angezeigt. Aktiviere dies nur, wenn dein Server das Sonnenwacht-Weltereignis aktiv hat.",
        ["koKR"] = "활성화하면 태양의 손길 전투 퀘스트의 위치가 지도/소형지도에 표시됩니다. 서버에 태양의 손길 월드 상태 이벤트가 활성화된 경우에만 활성화하십시오.",
        ["esMX"] = "Cuando está habilitado, las ubicaciones de las misiones de la Batalla por el Alcance del Sol se mostrarán en el mapa/minimapa. Habilita esto solo si tu servidor tiene el evento de estado del mundo Alcance del Sol activo.",
        ["enUS"] = true,
        ["zhCN"] = "启用后，太阳之手战役任务的位置将显示在地图/小地图上。仅当您的服务器拥有太阳之手世界状态事件时才启用此功能。",
        ["zhTW"] = "啟用後，太陽之手戰役任務的位置將顯示在地圖/小地圖上。僅當您的伺服器有太陽之手世界狀態事件時才啟用此功能。",
        ["esES"] = "Cuando está habilitado, las ubicaciones de las misiones de la Batalla por el Alcance del Sol se mostrarán en el mapa/minimapa. Habilita esto solo si tu servidor tiene el evento de estado del mundo Alcance del Sol activo.",
        ["frFR"] = "Lorsque cette option est activée, les emplacements des quêtes de la Bataille pour l'Essor du Soleil seront affichés sur la carte/minimap. Activez ceci uniquement si votre serveur a l'événement d'état du monde Essor du Soleil actif.",
    },
}
