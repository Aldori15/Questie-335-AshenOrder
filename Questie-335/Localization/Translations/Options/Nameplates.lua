...
local nameplateOptionsLocales = {
    ...
    ["Show Objective Text"] = {
        ["ptBR"] = "Mostrar texto do objetivo",
        ["ruRU"] = "Показать текст цели",
        ["deDE"] = "Zieltext anzeigen",
        ["koKR"] = "목표 텍스트 표시",
        ["esMX"] = "Mostrar texto de objetivo",
        ["enUS"] = true,
        ["zhCN"] = "显示目标文本",
        ["zhTW"] = "顯示目標文字",
        ["esES"] = "Mostrar texto de objetivo",
        ["frFR"] = "Afficher le texte de l'objectif",
    },
    ["Show objective progress text next to quest icons on creature nameplates."] = {
        ["ptBR"] = "Mostra o texto do progresso do objetivo ao lado dos ícones de missão nas placas de identificação das criaturas.",
        ["ruRU"] = "Показывает текст прогресса цели рядом со значками заданий на индикаторах здоровья существ.",
        ["deDE"] = "Zeigt den Fortschrittstext des Ziels neben den Quest-Icons an den Namensplaketten von Kreaturen an.",
        ["koKR"] = "퀘스트 아이콘 옆에 목표 진행 텍스트를 표시합니다.",
        ["esMX"] = "Muestra el texto de progreso del objetivo junto a los iconos de misión en las placas de nombre de las criaturas.",
        ["enUS"] = true,
        ["zhCN"] = "在生物姓名板的任务图标旁显示目标进度文本。",
        ["zhTW"] = "在怪物名條的任務圖示旁顯示目標進度文字。",
        ["esES"] = "Muestra el texto de progreso del objetivo junto a los iconos de misión en las placas de nombre de las criaturas.",
        ["frFR"] = "Affiche le texte de progression de l'objectif à côté des icônes de quête sur les barres de vie flottantes des monstres.",
    },
    ["Only Show Objective Text On Target"] = {
        ["ptBR"] = "Mostrar texto do objetivo apenas no alvo",
        ["ruRU"] = "Показывать текст цели только на цели",
        ["deDE"] = "Zieltext nur am Ziel anzeigen",
        ["koKR"] = "대상에게만 목표 텍스트 표시",
        ["esMX"] = "Mostrar texto de objetivo solo en el objetivo",
        ["enUS"] = true,
        ["zhCN"] = "仅在目标上显示目标文本",
        ["zhTW"] = "只在目標上顯示目標文字",
        ["esES"] = "Mostrar texto de objetivo solo en el objetivo",
        ["frFR"] = "Afficher le texte de l'objectif uniquement sur la cible",
    },
    ["Only show objective progress text on the selected creature nameplate."] = {
        ["ptBR"] = "Mostra o texto do progresso do objetivo apenas na placa de identificação da criatura selecionada.",
        ["ruRU"] = "Показывает текст прогресса цели только на индикаторе выбранного существа.",
        ["deDE"] = "Zeigt den Fortschrittstext des Ziels nur an der Namensplakette der ausgewählten Kreatur an.",
        ["koKR"] = "선택한 생물 이름표에만 목표 진행 텍스트를 표시합니다.",
        ["esMX"] = "Muestra el texto de progreso del objetivo solo en la placa de nombre de la criatura seleccionada.",
        ["enUS"] = true,
        ["zhCN"] = "仅在已选择的生物姓名板上显示目标进度文本。",
        ["zhTW"] = "只在已選取的怪物名條上顯示目標進度文字。",
        ["esES"] = "Muestra el texto de progreso del objetivo solo en la placa de nombre de la criatura seleccionada.",
        ["frFR"] = "Affiche le texte de progression de l'objectif uniquement sur la barre de vie flottante du monstre sélectionné.",
    },
    ["Icon Position X"] = {
    ...
    ["Objective Text Scale"] = {
        ["ptBR"] = "Escala do texto do objetivo",
        ["ruRU"] = "Размер текста цели",
        ["deDE"] = "Skalierung des Zieltexts",
        ["koKR"] = "목표 텍스트 크기",
        ["esMX"] = "Escala del texto de objetivo",
        ["enUS"] = true,
        ["zhCN"] = "目标文本缩放",
        ["zhTW"] = "目標文字縮放",
        ["esES"] = "Escala del texto de objetivo",
        ["frFR"] = "Échelle du texte de l'objectif",
    },
    ["Scale the size of objective text on creature nameplates. ( Default: %s )"] = {
        ["ptBR"] = "Ajusta o tamanho do texto do objetivo nas placas de identificação das criaturas. (Padrão: %s)",
        ["ruRU"] = "Регулировка размера текста цели на индикаторах здоровья существ (по умолчанию: %s)",
        ["deDE"] = "Skaliert die Größe des Zieltexts an den Namensplaketten von Kreaturen. ( Standard: %s )",
        ["koKR"] = "생물 이름표에 표시되는 목표 텍스트의 크기를 조절합니다. ( 기본값: %s )",
        ["esMX"] = "Escala el tamaño del texto del objetivo en las placas de nombre de las criaturas. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "调整生物姓名板上目标文本的大小。（默认：%s）",
        ["zhTW"] = "調整怪物名條上目標文字的大小。(預設值: %s )",
        ["esES"] = "Escala el tamaño del texto del objetivo en las placas de nombre de las criaturas. (Predeterminado: %s)",
        ["frFR"] = "Définis la taille du texte d'objectif sur les barres de vie flottantes des monstres. (Par défaut : %s)",
    },
    ["Objective Text Position X"] = {
        ["ptBR"] = "Posição X do texto do objetivo",
        ["ruRU"] = "Позиция текста цели по оси X",
        ["deDE"] = "Zieltext-Position X",
        ["koKR"] = "목표 텍스트 위치 X",
        ["esMX"] = "Posición X del texto de objetivo",
        ["enUS"] = true,
        ["zhCN"] = "目标文本X座标",
        ["zhTW"] = "目標文字水平位置",
        ["esES"] = "Posición X del texto de objetivo",
        ["frFR"] = "Position X du texte de l'objectif",
    },
    ["Where on the X axis the nameplate objective text should be. ( Default: %s )"] = {
        ["ptBR"] = "Onde o texto do objetivo deve ficar no eixo X da placa de identificação. (Padrão: %s)",
        ["ruRU"] = "Положение текста цели на индикаторе здоровья по оси X (по умолчанию: %s)",
        ["deDE"] = "An welcher Stelle auf der X-Achse der Zieltext an Namensplaketten angezeigt werden soll. ( Standard: %s )",
        ["koKR"] = "이름표 목표 텍스트의 X좌표를 설정합니다. ( 기본값: %s )",
        ["esMX"] = "Dónde debería estar el texto del objetivo en el eje X de la placa de nombre. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "姓名板目标文本的X轴位置。（默认：%s）",
        ["zhTW"] = "名條目標文字的水平方向位置。(預設值: %s )",
        ["esES"] = "Dónde debería estar el texto del objetivo en el eje X de la placa de nombre. (Predeterminado: %s)",
        ["frFR"] = "Définis la position horizontale du texte d'objectif sur la barre de vie flottante. (Par défaut : %s)",
    },
    ["Objective Text Position Y"] = {
        ["ptBR"] = "Posição Y do texto do objetivo",
        ["ruRU"] = "Позиция текста цели по оси Y",
        ["deDE"] = "Zieltext-Position Y",
        ["koKR"] = "목표 텍스트 위치 Y",
        ["esMX"] = "Posición Y del texto de objetivo",
        ["enUS"] = true,
        ["zhCN"] = "目标文本Y座标",
        ["zhTW"] = "目標文字垂直位置",
        ["esES"] = "Posición Y del texto de objetivo",
        ["frFR"] = "Position Y du texte de l'objectif",
    },
    ["Where on the Y axis the nameplate objective text should be. ( Default: %s )"] = {
        ["ptBR"] = "Onde o texto do objetivo deve ficar no eixo Y da placa de identificação. (Padrão: %s)",
        ["ruRU"] = "Положение текста цели на индикаторе здоровья по оси Y (по умолчанию: %s)",
        ["deDE"] = "An welcher Stelle auf der Y-Achse der Zieltext an Namensplaketten angezeigt werden soll. ( Standard: %s )",
        ["koKR"] = "이름표 목표 텍스트의 Y좌표를 설정합니다. ( 기본값: %s )",
        ["esMX"] = "Dónde debería estar el texto del objetivo en el eje Y de la placa de nombre. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "姓名板目标文本的Y轴位置。（默认：%s）",
        ["zhTW"] = "名條目標文字的垂直方向位置。(預設值: %s )",
        ["esES"] = "Dónde debería estar el texto del objetivo en el eje Y de la placa de nombre. (Predeterminado: %s)",
        ["frFR"] = "Définis la position verticale du texte d'objectif sur la barre de vie flottante. (Par défaut : %s)",
    },
    ["Reset Nameplates"] = {
