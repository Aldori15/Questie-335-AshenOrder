...
local classicObjectiveLocales = {
    ["Slay slimes until they leave behind a Rusty Chest"] = {
        ...
        ["esES"] = "Mata limos hasta que dejen un cofre oxidado",
        ["esMX"] = "Mata limos hasta que dejen un cofre oxidado",
        ["frFR"] = "Tuez des limons jusqu'à ce qu'ils laissent un coffre rouillé",
        ["koKR"] = "녹슨 상자를 남길 때까지 슬라임 처치",
        ["ptBR"] = "Mate limos até que deixem um Baú Enferrujado",
        ["ruRU"] = "Убивайте слизней, пока они не оставят ржавый сундук",
        ["zhCN"] = "击杀软泥怪，直到它们留下一个生锈的箱子",
        ["zhTW"] = "殺死軟泥怪，直到它們留下生鏽的箱子",
    },
    ["Talk to Estelle Gendry"] = {
        ["enUS"] = true,
        ["deDE"] = "Sprich mit Estelle Gendry",
        ["esES"] = "Habla con Estelle Gendry",
        ["esMX"] = "Habla con Estelle Gendry",
        ["frFR"] = "Parlez à Estelle Gendry",
        ["koKR"] = "에스텔 겐드리와 대화",
        ["ptBR"] = "Fale com Estelle Gendry",
        ["ruRU"] = "Поговорите с Эстель Джендри",
        ["zhCN"] = "与埃斯特尔·金迪交谈",
        ["zhTW"] = "與埃斯特爾·金迪交談",
    },
    ["Open the chest"] = {
    ...
    ["Use the E.C.A.C. to weaken it"] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze den E.C.A.C., um es zu schwächen",
        ["esES"] = "Usa el E.C.A.C. para debilitarlo",
        ["esMX"] = "Usa el E.C.A.C. para debilitarlo",
        ["frFR"] = "Utilisez l'E.C.A.C. pour l'affaiblir",
        ["koKR"] = "E.C.A.C.를 사용하여 약화",
        ["ptBR"] = "Use o E.C.A.C. para enfraquecê-lo",
        ["ruRU"] = "Используйте E.C.A.C., чтобы ослабить его",
        ["zhCN"] = "使用E.C.A.C.削弱它",
        ["zhTW"] = "使用E.C.A.C.削弱它",
    },
    ["Use the Empty Leaden Collection Phial."] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze das leere bleierne Sammelgefäß.",
        ["esES"] = "Usa el frasco de plomo vacío.",
        ["esMX"] = "Usa el frasco de plomo vacío.",
        ["frFR"] = "Utilisez le flacon de collecte en plomb vide.",
        ["koKR"] = "빈 납 수집 약병을 사용하세요.",
        ["ptBR"] = "Use o frasco de coleta de chumbo vazio.",
        ["ruRU"] = "Используйте пустой свинцовый сосуд для сбора.",
        ["zhCN"] = "使用空的铅制收集瓶。",
        ["zhTW"] = "使用空的鉛製收集瓶。",
    },
    ["Hold off Kolkar invaders until Warlord Krom'zar spawns and then loot the banner spawned on his corpse."] = {
        ["enUS"] = true,
        ["deDE"] = "Halte die Kolkar-Invasoren auf, bis Kriegsherr Krom'zar erscheint, und plündere dann das Banner auf seiner Leiche.",
        ["esES"] = "Contén a los invasores Kolkar hasta que aparezca el Señor de la Guerra Krom'zar y luego saquea el estandarte de su cadáver.",
        ["esMX"] = "Contén a los invasores Kolkar hasta que aparezca el Señor de la Guerra Krom'zar y luego saquea el estandarte de su cadáver.",
        ["frFR"] = "Repoussez les envahisseurs kolkar jusqu'à l'apparition du seigneur de guerre Krom'zar, puis récupérez la bannière sur son cadavre.",
        ["koKR"] = "전쟁군주 크롬자르가 나타날 때까지 콜카르 침입자를 막고, 그의 시체에 나타난 깃발을 전리품으로 획득하세요.",
        ["ptBR"] = "Impeça os invasores Kolkar até que o Senhor da Guerra Krom'zar apareça e saqueie a bandeira em seu cadáver.",
        ["ruRU"] = "Сдерживайте захватчиков Колкара, пока не появится воевода Кром'зар, затем заберите знамя с его трупа.",
        ["zhCN"] = "阻止科尔卡入侵者，直到克罗姆扎军阀出现，然后拾取他尸体上出现的旗帜。",
        ["zhTW"] = "阻止科爾卡入侵者，直到克羅姆扎軍閥出現，然後拾取他屍體上出現的旗幟。",
    },
    ["Use the Draco-Incarcinatrix 900 and defeat the dragonkin."] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze den Draco-Incarcinatrix 900 und besiege die Drachenbrut.",
        ["esES"] = "Usa el Draco-Incarcinatrix 900 y derrota a los dragonantes.",
        ["esMX"] = "Usa el Draco-Incarcinatrix 900 y derrota a los dragonantes.",
        ["frFR"] = "Utilisez le Draco-Incarcinatrix 900 et vainquez les draconiens.",
        ["koKR"] = "드라코-인카시네이터 900을 사용하여 용족을 처치하세요.",
        ["ptBR"] = "Use o Draco-Incarcinatrix 900 e derrote os dragonianos.",
        ["ruRU"] = "Используйте Драко-Инкарцинатор 900 и победите драконов.",
        ["zhCN"] = "使用龙族禁锢器900并击败龙类。",
        ["zhTW"] = "使用龍族禁錮器900並擊敗龍類。",
    },
    ["Open the cage"] = {
        ["enUS"] = true,
    ...
    ["Use the Cenarion Moondust"] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze den Mondstaub der Zandalar",
        ["esES"] = "Usa el Polvo lunar de Cenarion",
        ["esMX"] = "Usa el Polvo lunar de Cenarion",
        ["frFR"] = "Utilisez la poussière lunaire cénarienne",
        ["koKR"] = "세나리온 달가루 사용",
        ["ptBR"] = "Use a Poeira Lunar Cenariana",
    ...
    ["Defeat Lunaclaw"] = {
        ...
        ["esES"] = "Derrota a Garra de Luna",
        ["esMX"] = "Derrota a Garra de Luna",
        ["frFR"] = "Vainquez Griffe-de-Lune",
        ["koKR"] = "달의 발톱 처치",
        ["ptBR"] = "Derrote Garra da Lua",
        ["ruRU"] = "Победите Лунокогтя",
        ["zhCN"] = "击败月爪",
        ["zhTW"] = "擊敗月爪",
    },
    ["Use the Cenarion Lunardust"] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze den Cenarius-Mondstaub",
        ["esES"] = "Usa el Polvo lunar de Cenarion",
        ["esMX"] = "Usa el Polvo lunar de Cenarion",
        ["frFR"] = "Utilisez la poussière lunaire cénarienne",
        ["koKR"] = "세나리온 달가루 사용",
    ...
    ["Use the Aspect of Neptulon."] = {
        ...
        ["ruRU"] = "Используйте облик Нептула.",
        ["zhCN"] = "使用耐普图隆的化身。",
        ["zhTW"] = "使用奈普圖隆的化身。",
    },
    ["Imprison the Doomguard Commander"] = {
        ["enUS"] = true,
        ["deDE"] = "Sperre den Kommandanten der Verdammniswache ein",
        ["esES"] = "Aprisiona al comandante Guardia apocalíptica",
        ["esMX"] = "Aprisiona al comandante Guardia apocalíptica",
        ["frFR"] = "Emprisonnez le commandant garde funeste",
        ["koKR"] = "파멸의 수호병 사령관을 가두세요",
        ["ptBR"] = "Aprisione o Comandante da Guarda Vil",
        ["ruRU"] = "Заточите командира стражи погибели",
        ["zhCN"] = "囚禁末日守卫指挥官",
        ["zhTW"] = "囚禁末日守衛指揮官",
    },
    ["Silithyst"] = {
