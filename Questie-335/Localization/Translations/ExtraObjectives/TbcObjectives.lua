...
local tbcObjectiveLocales = {
    ["Attempt to loot The Thunderspike"] = {
        ["enUS"] = true,
        ["deDE"] = "Versuche, den Donnerspieß zu plündern",
        ["esES"] = "Intenta saquear la Pica del Trueno",
        ["esMX"] = "Intenta saquear la Pica del Trueno",
        ["frFR"] = "Essayez de récupérer la Foudre-pique",
        ["koKR"] = "천둥창을 획득하려고 시도",
        ["ptBR"] = "Tente saquear a Lança do Trovão",
        ["ruRU"] = "Попытайтесь добыть Громовой шип",
        ["zhCN"] = "尝试拾取雷刺",
        ["zhTW"] = "嘗試拾取雷刺",
    },
    ["Charge the Vekh'nir Crystal"] = {
        ...
        ["esES"] = "Carga el cristal Vekh'nir",
        ["esMX"] = "Carga el cristal Vekh'nir",
        ["frFR"] = "Chargez le cristal de Vekh'nir",
        ["koKR"] = "벡니르 수정 충전",
        ["ptBR"] = "Carregue o Cristal Vekh'nir",
        ["ruRU"] = "Зарядите кристалл Век'нира",
        ["zhCN"] = "为维克尼尔水晶充能",
        ["zhTW"] = "為維克尼爾水晶充能",
    },
    ["Control the Marmot"] = {
        ["enUS"] = true,
        ["deDE"] = "Steuere das Murmeltier",
        ["esES"] = "Controla la marmota",
        ["esMX"] = "Controla la marmota",
        ["frFR"] = "Contrôlez la marmotte",
        ["koKR"] = "마못 조종",
        ["ptBR"] = "Controle a marmota",
        ["ruRU"] = "Управляйте сурком",
        ["zhCN"] = "控制土拨鼠",
        ["zhTW"] = "控制土撥鼠",
    },
    ["Fish for Baby Crocolisk"] = {
        ["enUS"] = true,
        ["deDE"] = "Angle nach Babykrokilisken",
        ["esES"] = "Pesca crías de crocolisco",
        ["esMX"] = "Pesca crías de crocolisco",
        ["frFR"] = "Pêchez des bébés crocilisques",
        ["koKR"] = "새끼 악어 낚기",
        ["ptBR"] = "Pesque Crocoliscos Bebês",
        ["ruRU"] = "Ловите детенышей кроколисков",
        ["zhCN"] = "钓取小鳄鱼",
        ["zhTW"] = "釣取小鱷魚",
    },
    ["Get a disguise"] = {
        ["enUS"] = true,
        ["deDE"] = "Besorge dir eine Verkleidung",
        ["esES"] = "Consigue un disfraz",
        ["esMX"] = "Consigue un disfraz",
        ["frFR"] = "Obtenez un déguisement",
        ["koKR"] = "변장 도구 획득",
        ["ptBR"] = "Consiga um disfarce",
        ["ruRU"] = "Получите маскировку",
        ["zhCN"] = "获得伪装",
        ["zhTW"] = "取得偽裝",
    },
    ["Kill Siltfin Murlocs to summon a Quel'dorei Magewrath"] = {
        ["enUS"] = true,
        ["deDE"] = "Töte Schlammflossen-Murlocs, um einen Quel'dorei-Magierzorn zu beschwören",
        ["esES"] = "Mata múrlocs Aleta de Lodo para invocar a un Mago de Quel'dorei",
        ["esMX"] = "Mata múrlocs Aleta de Lodo para invocar a un Mago de Quel'dorei",
        ["frFR"] = "Tuez des murlocs Aileron-Boueux pour invoquer un Magecourroux quel'dorei",
        ["koKR"] = "실트핀 멀록을 처치하여 쿠엘도레이 마법분노 소환",
        ["ptBR"] = "Mate Murlocs Barbatana de Lodo para invocar um Mago Furioso Quel'dorei",
        ["ruRU"] = "Убивайте мурлоков из племени Грязеплавников, чтобы призвать мага ярости Кель'дорай",
        ["zhCN"] = "击杀淤泥鳍鱼人以召唤一个奎尔多雷法师之怒",
        ["zhTW"] = "擊殺淤泥鰭魚人以召喚一名奎爾多雷法師之怒",
    },
    ["Open the cage"] = {
        ["enUS"] = true,
    ...
    ["Open the container"] = {
        ...
        ["esES"] = "Abre el contenedor",
        ["esMX"] = "Abre el contenedor",
        ["frFR"] = "Ouvrez le conteneur",
        ["koKR"] = "용기 열기",
        ["ptBR"] = "Abra o recipiente",
        ["ruRU"] = "Откройте контейнер",
        ["zhCN"] = "打开容器",
        ["zhTW"] = "打開容器",
    },
    ["Take a ride"] = {
        ["enUS"] = true,
        ["deDE"] = "Nimm eine Fahrt",
        ["esES"] = "Da un paseo",
        ["esMX"] = "Da un paseo",
        ["frFR"] = "Faites un tour",
        ["koKR"] = "탑승",
        ["ptBR"] = "Pegue uma carona",
        ["ruRU"] = "Отправьтесь на прогулку",
        ["zhCN"] = "乘坐交通工具",
        ["zhTW"] = "搭乘交通工具",
    },
    ["Use 6 Ruuan'ok Claws to summon a Harbinger of the Raven"] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze 6 Klauen von Ruuan'ok, um einen Vorboten des Raben zu beschwören",
        ["esES"] = "Usa 6 garras de Ruuan'ok para invocar a un Heraldo del Cuervo",
        ["esMX"] = "Usa 6 garras de Ruuan'ok para invocar a un Heraldo del Cuervo",
        ["frFR"] = "Utilisez 6 griffes de Ruuan'ok pour invoquer un héraut du Corbeau",
        ["koKR"] = "루안오크 발톱 6개를 사용하여 까마귀의 전령 소환",
        ["ptBR"] = "Use 6 Garras de Ruuan'ok para invocar um Arauto do Corvo",
        ["ruRU"] = "Используйте 6 когтей Ру'анока, чтобы призвать предвестника ворона",
        ["zhCN"] = "使用6个鲁安诺克之爪召唤乌鸦先驱",
        ["zhTW"] = "使用6個魯安諾克之爪召喚烏鴉先驅",
    },
    ["Use Apex's Crystal Focus near Archmage Vargoth's Orb"] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze Apex' Kristallfokus in der Nähe von Erzmagier Vargoths Kugel",
        ["esES"] = "Usa el Foco de cristal de Apex cerca del Orbe del archimago Vargoth",
        ["esMX"] = "Usa el Foco de cristal de Apex cerca del Orbe del archimago Vargoth",
        ["frFR"] = "Utilisez le foyer de cristal d'Apex près de l'orbe de l'archimage Vargoth",
        ["koKR"] = "대마법사 바르고스의 보주 근처에서 에이펙스의 수정 초점 사용",
        ["ptBR"] = "Use o Foco de Cristal de Apex perto do Orbe do Arquimago Vargoth",
        ["ruRU"] = "Используйте кристалл-фокус Алекса возле сферы верховного мага Варгота",
        ["zhCN"] = "在大法师瓦格斯的宝珠附近使用阿佩克斯的水晶焦点",
        ["zhTW"] = "在大法師瓦格斯的寶珠附近使用阿佩克斯的水晶焦點",
    },
    ["Use Navuud's Concoction before attacking Seeping Sludges"] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze Navuuds Mixtur, bevor du Sickernden Schlamm angreifst",
        ["esES"] = "Usa la Mezcla de Navuud antes de atacar a los cienos rezumantes",
        ["esMX"] = "Usa la Mezcla de Navuud antes de atacar a los cienos rezumantes",
        ["frFR"] = "Utilisez la concoction de Navuud avant d'attaquer les limons suintants",
        ["koKR"] = "흘러내리는 오염물을 공격하기 전에 나부드의 혼합물 사용",
        ["ptBR"] = "Use a Mistura de Navuud antes de atacar os Lodos Gotejantes",
        ["ruRU"] = "Используйте смесь Навууда перед атакой на сочащихся слизней",
        ["zhCN"] = "攻击渗流软泥怪前使用纳乌德的混合药剂",
        ["zhTW"] = "攻擊滲流軟泥怪前使用納烏德的混合藥劑",
    },
    ["Use Navuud's Concoction before attacking Void Wastes"] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze Navuuds Mixtur, bevor du Leerenöden angreifst",
        ["esES"] = "Usa la Mezcla de Navuud antes de atacar a los baldíos del Vacío",
        ["esMX"] = "Usa la Mezcla de Navuud antes de atacar a los baldíos del Vacío",
        ["frFR"] = "Utilisez la concoction de Navuud avant d'attaquer les désolations du Vide",
        ["koKR"] = "공허의 황무지를 공격하기 전에 나부드의 혼합물 사용",
        ["ptBR"] = "Use a Mistura de Navuud antes de atacar os Desertos do Caos",
        ["ruRU"] = "Используйте смесь Навууда перед атакой на пустоши Бездны",
        ["zhCN"] = "攻击虚空荒地前使用纳乌德的混合药剂",
        ["zhTW"] = "攻擊虛空荒地前使用納烏德的混合藥劑",
    },
    ["Use the cannon"] = {
        ["enUS"] = true,
        ...
        ["esES"] = "Usa el cañón",
        ["esMX"] = "Usa el cañón",
        ["frFR"] = "Utilisez le canon",
        ["koKR"] = "대포 사용",
        ["ptBR"] = "Use o canhão",
        ["ruRU"] = "Используйте пушку",
        ["zhCN"] = "使用大炮",
        ["zhTW"] = "使用大砲",
    },
